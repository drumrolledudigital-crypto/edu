...
<head>
    ...
    <title>Unauthorized | {{ \App\Models\Setting::get('platform_name', 'Drumroll') }}</title>
...
<body class="font-sans bg-gray-50 min-h-screen flex items-center justify-center">
    <div class="text-center px-6">
        <div class="w-20 h-20 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-6">
            <span class="text-4xl font-black text-red-600">403</span>
        </div>
        <h1 class="text-3xl font-black text-gray-900 mb-3">Unauthorized</h1>
        <p class="text-gray-500 mb-8 max-w-md mx-auto">You don't have permission to access this page.</p>
