...
<head>
    ...
    <title>Server Error | {{ \App\Models\Setting::get('platform_name', 'Drumroll') }}</title>
...
<body class="font-sans bg-gray-50 min-h-screen flex items-center justify-center">
    <div class="text-center px-6">
        <div class="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <span class="text-4xl font-black text-gray-600">500</span>
        </div>
        <h1 class="text-3xl font-black text-gray-900 mb-3">Server Error</h1>
        <p class="text-gray-500 mb-8 max-w-md mx-auto">Something went wrong on our end. Please try again later.</p>
